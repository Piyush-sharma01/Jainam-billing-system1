      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <form onSubmit={handleSubmit} className="bg-white border border-line p-6 space-y-5" noValidate>
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-royal text-white py-3 font-display font-medium text-sm hover:bg-deadly/90 transition-colors min-h-[48px]"
            >
