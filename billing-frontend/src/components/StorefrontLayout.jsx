        ...
        <div className="fixed inset-0 z-50 flex justify-end" role="dialog" aria-modal="true" aria-label="Shopping cart">
          ...
          <div className="relative bg-gray-50 w-full sm:w-[440px] h-full flex flex-col border-l border-gray-200 cart-drawer-enter">
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200 shrink-0">
              ...
              <button
                onClick={() => setCartOpen(false)}
                className="flex items-center justify-center w-9 h-9 border border-gray-200 text-gray-500 hover:text-royal hover:border-royal transition-colors"
            ...
            {orderPlaced ? (
              <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
                ...
                <button
                  ...
                  className="flex items-center gap-2 font-mono text-[11px] tracking-widest uppercase text-gray-500 hover:text-royal border border-gray-200 px-5 py-3 hover:border-royal transition-colors"
                >
